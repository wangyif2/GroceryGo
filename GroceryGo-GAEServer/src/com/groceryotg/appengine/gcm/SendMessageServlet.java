...
public class SendMessageServlet extends BaseServlet {
    ...
    /**
     * Creates the {@link com.google.android.gcm.server.Sender} based on the servlet settings.
     */
    ...
    private Message createMessage() {
        Message message = new Message.Builder().addData("GroceryOTG","groceryotg gcm test").build();
        return message;
    }
